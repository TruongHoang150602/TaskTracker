...
// import { Box, Typography, Grid, Paper, List, ListItem, ListItemText, ListItemButton, Divider, Switch, FormControlLabel } from '@mui/material';
...
//                 <Switch checked={notificationSettings.email} onChange={() => handleToggleNotification('email')} />
//               </StyledListItem>
//               <StyledListItem>
//                 <StyledListItemText primary="Push Notifications" />
//                 <Switch checked={notificationSettings.push} onChange={() => handleToggleNotification('push')} />
//               </StyledListItem>
//               <StyledListItem>
//                 <StyledListItemText primary="SMS" />
//                 <Switch checked={notificationSettings.sms} onChange={() => handleToggleNotification('sms')} />
//               </StyledListItem>
//             </List>
//           </Paper>
//         </Grid>
...
//               Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer posuere nunc in bibendum consectetur.
//               Nulla facilisi. Mauris elementum elit in enim vulputate, eu gravida ex accumsan. Sed eget malesuada dui. Sed
//               auctor nisl nunc, id fermentum purus sollicitudin a.
//             </Typography>
//           </Paper>
//         </Grid>
//       </Grid>
